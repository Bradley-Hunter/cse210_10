...
using cse210_10.Game.Scripting;
using cse210_10.Game.Services;


namespace cse210_10.Game.Directing
{
    /// <summary>
    ...
    public class Director : ActionCallback
    {
        ...
        {
            List<cse210_10.Game.Scripting.Action> actions = script.GetActions(group);
            foreach(cse210_10.Game.Scripting.Action action in actions)
            {
